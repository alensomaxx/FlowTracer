...
MERCHANT_UPI_ID = "alensocreation@okhdfcbank" # Replace with your actual Costa Coffee UPI ID
MERCHANT_NAME = "Costa Coffee"

# --- Helper Function to Generate UPI Link (Same as your Streamlit app) ---
...
# --- Helper Function to Generate QR Code as Base64 Image (Slightly modified for Tkinter) ---
